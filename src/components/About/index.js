      ...
      <div className="flex flex-row  gap-6 ml-8">
        <div className="flex-col mt-14 flex flex-auto w-64 gap-6">
          <h3 className="text-3xl font-medium" data-aos={"fade-left"}>
            I'm <span className="text-yellow-600">Khashayar Morapdour,</span> an aspiring Software
            Engineer
          </h3>
          <p
          ...
          <p
            ...
            data-aos={"fade-right"}
          >
            I am currently looking for Data Analatics and software Engineering Internsgips.I worked on reactJs, NextJs, TypeScript, python and many more. I am
