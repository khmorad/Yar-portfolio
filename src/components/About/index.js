...
// Importing a DownloadIcon component from Material-UI library
import DownloadIcon from "@mui/icons-material/Download";

// Importing an animation player from LottieFiles library
import * as LottiePlayer from "@lottiefiles/lottie-player";

// Defining the About component as a default export
export default function About() {

  // Function to calculate the age dynamically
  const getDate = () => {
      ...
      <div className="flex flex-row  gap-6 ml-8">
        ...
        <div className="flex-col mt-14 flex flex-auto w-64 gap-6">
          <h3 className="text-3xl font-medium" data-aos={"fade-left"}>
            I'm <span className="text-yellow-600">Khashayar Morapdour,</span> an aspiring Software Engineer
          </h3>
          <p
